...
export const productGalleries: Record<string, ProductGalleryImage[]> = {
  ...
  "7ML5881-0AC01-0AD9-Z": [
    { src: siemensLevelImage1, alt: "Radar de onda guiada SITRANS LG250 en vista frontal" },
    { src: siemensLevelImage2, alt: "Radar de onda guiada SITRANS LG250 en vista frontal alternativa" },
    { src: siemensLevelImage3, alt: "Sonda del radar de onda guiada SITRANS LG250" },
    { src: siemensLevelImage4, alt: "Radar de onda guiada SITRANS LG250 con sonda" },
    { src: siemensLevelImage5, alt: "Placa del radar de onda guiada SITRANS LG250" },
    { src: siemensLevelImage6, alt: "Radar de onda guiada SITRANS LG250 con empaque" },
  ],
  "7NG3136-0AC11": [
    { src: siemensTemperatureImage1, alt: "Transmisor de Temperatura de Campo SITRANS TF en vista diagonal" },
    { src: siemensTemperatureImage2, alt: "Transmisor de Temperatura de Campo SITRANS TF en su empaque" },
    { src: siemensTemperatureImage3, alt: "Transmisor de Temperatura de Campo SITRANS TF en vista lateral" },
    { src: siemensTemperatureImage4, alt: "Transmisor de Temperatura de Campo SITRANS TF en vista frontal" },
    { src: siemensTemperatureImage5, alt: "Transmisor de Temperatura de Campo SITRANS TF en vista posterior" },
    { src: siemensTemperatureImage6, alt: "Transmisor de Temperatura de Campo SITRANS TF en vista adicional" },
  ],
  "7MF1567-3CA00-5BA1": [
    { src: siemensP220Image1, alt: "Transmisor de presión SITRANS P220 de 0-10 Bar en vista frontal" },
    { src: siemensP220Image2, alt: "Transmisor de presión SITRANS P220 de 0-10 Bar en vista frontal alternativa" },
    { src: siemensP220Image3, alt: "Transmisor de presión SITRANS P220 de 0-10 Bar en vista lateral" },
  ],
  "7MF44331EY221AC1-Z": [
    { src: siemensDifferentialImage1, alt: "Transmisor Diferencial SITRANS P DS III HART en vista de placa" },
    { src: siemensDifferentialImage2, alt: "Transmisor Diferencial SITRANS P DS III HART en vista frontal" },
    { src: siemensDifferentialImage3, alt: "Transmisor Diferencial SITRANS P DS III HART con conexiones" },
    { src: siemensDifferentialImage4, alt: "Transmisor Diferencial SITRANS P DS III HART en vista lateral" },
    { src: siemensDifferentialImage5, alt: "Transmisor Diferencial SITRANS P DS III HART en su empaque" },
    { src: siemensDifferentialImage6, alt: "Transmisor Diferencial SITRANS P DS III HART en vista adicional" },
  ],
  "3300": [
    { src: rosemount3300Image1, alt: "Transmisor de Nivel por Radar de Onda Guiada Rosemount con sonda" },
    { src: rosemount3300Image2, alt: "Transmisor de Nivel por Radar de Onda Guiada Rosemount en vista lateral" },
    { src: rosemount3300Image3, alt: "Placa del transmisor de Nivel por Radar de Onda Guiada Rosemount" },
    { src: rosemount3300Image4, alt: "Transmisor de Nivel por Radar de Onda Guiada Rosemount en vista adicional" },
  ],
  "S7-1500": [
    {
      src: s71500Image,
...
export const productCharacteristics: Record<string, string[]> = {
  "E122-2BSB": [
    "Termostato Industrial Heavy-Duty United Electric",
    "Referencia de catálogo: E122-2BSB",
    "Rango indicado en el catálogo: 30–250 °F",
    "Control de temperatura hermético a prueba de explosión (Clase I Div 1)",
    "Estado, conexión y configuración deben confirmarse antes de cotizar",
  ],
  "7NG3136-0AC11": [
    "Transmisor de Temperatura de Campo Siemens SITRANS TF",
    "Referencia de catálogo: 7NG3136-0AC11",
    "Cabezal IP67 de aluminio con display digital e integración HART",
    "Rango, salida, alimentación y configuración deben confirmarse con la placa y la ficha técnica",
  ],
  "3300": [
    "Transmisor de Nivel por Radar de Onda Guiada Rosemount",
    "Referencia comercial: 3300",
    "Instrumentación de proceso de nivel continuo para líquidos severos",
    "Longitud de sonda, conexión, salida, alimentación y estado deben confirmarse antes de cotizar",
  ],
  "7MF1567-3CA00-5BA1": [
    "Transmisor de Presión Siemens SITRANS P220 (0-10 Bar)",
    "Referencia de catálogo: 7MF1567-3CA00-5BA1",
    "Transmisor compacto piezorresistivo de acero inoxidable 4-20 mA",
    "Rango, alimentación y configuración deben confirmarse con la placa y la ficha técnica",
  ],
  "7MF44331EY221AC1-Z": [
    "Transmisor Diferencial Siemens SITRANS P DS III HART",
    "Referencia de catálogo: 7MF44331EY221AC1-Z",
    "Transmisor inteligente con celda de alta precisión y display local",
    "Protocolo HART, rango, salida y configuración deben confirmarse con la placa completa",
  ],
  "7ML5881-0AC01-0AD9-Z": [
    "Radar de Onda Guiada Siemens SITRANS LG250",
    "Referencia de catálogo: 7ML5881-0AC01-0AD9-Z",
    "Tecnología GWR de alta gama para nivel e interfaz en tanques",
    "Longitud de sonda, rango, conexión y configuración deben confirmarse antes de cotizar",
  ],
  "S7-1500": [
  ...
  "142P": [
    "Presostato de Baja Presión Nega-Rate ITT Neo-Dyn",
    "Modelo visible en placa: 142P81C6443",
    "Rango incremental visible: 2 a 40 inH2O",
    "Equipo a prueba de explosión para rangos críticos",
  ],
  "646GZE11": [
  ...
  "91MC27289": [
    ...
    "Sensor monocristalino DPharp de alta estabilidad a largo plazo",
    "Salida, rango y configuración deben validarse con la placa completa",
  ],
  "ASCO-3/4-24VDC": [
